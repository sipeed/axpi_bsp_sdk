...
/* Define to 1 if you have the declaration of `SHM_ANON', and to 0 if you
   don't. */
/* #undef HAVE_DECL_SHM_ANON */
...
#define MINIGUI_INTERFACE_AGE 1

/* Major version of MiniGUI */
#define MINIGUI_MAJOR_VERSION 5

/* Micro version of MiniGUI */
#define MINIGUI_MICRO_VERSION 1
...
#define PACKAGE_STRING "libminigui 5.0.1"
...
/* Define if virtual window enabled */
/* #undef _MGHAVE_VIRTUAL_WINDOW */
...
/* #undef _MGSCHEMA_COMPOSITING */

/* Define if use legacy schema (shared frame buffer) for the current runmode
   */
#define _MGSCHEMA_SHAREDFB 1

/* Define if use the fallback implementation for mgslice_xxx */
/* #undef _MGSLICE_FALLBACK */
...
/* Define if use shm_open */
/* #undef _MGUSE_SHMOPEN */

/* Define if use update region for cumulative updating surfaces */
#define _MGUSE_UPDATE_REGION 1
...
/* Define for targets which use GAL and/or IAL engines which use external
   implementation */
